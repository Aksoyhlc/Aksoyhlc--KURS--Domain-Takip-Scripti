...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#musterimenu" aria-expanded="true" aria-controls="musterimenu">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#domainmenu" aria-expanded="true" aria-controls="domainmenu">
          <i class="fas fa-fw fa-cog"></i>
          <span>Domainler</span>
        </a>
